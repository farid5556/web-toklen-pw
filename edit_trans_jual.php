...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE trans_jual SET kode_produk=?, tgl_trans=?, jlh_trans=? WHERE no_faktur=?");
    $stmt->bind_param("sssi", $kode_produk, $tgl_trans, $jlh_trans, $no_faktur);
    ...
    $no_faktur = $_GET['id'];
    $sql = "SELECT * FROM trans_jual WHERE no_faktur=?";
...
<body>
    <div class="container">
        ...
        <form method="POST" action="edit_trans_jual.php">
            ...
            <button type="submit">Update jual</button>
        </form>
        <div class="back-button">
            <a href="tambah_trans_jual.php">Back</a>
        </div>
    </div>
</body>
</html>
